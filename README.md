...
> **Personal note:** I've been using `--max-iterations 50` as my default to avoid runaway costs during experimentation. Bump it up to 100+ for complex tasks like full fine-tuning pipelines.
